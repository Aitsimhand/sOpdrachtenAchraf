...
(
    ...
    naam     VARCHAR(12)
        CONSTRAINT m_naam_nn NOT NULL,
    voorl    VARCHAR(5)
        CONSTRAINT m_voorl_nn NOT NULL,
    functie  VARCHAR(10),
    chef     NUMERIC(4)
        CONSTRAINT m_chef_fk REFERENCES medewerkers DEFERRABLE,
    gbdatum  DATE
        CONSTRAINT m_gebdat_nn NOT NULL,
    maandsal NUMERIC(6, 2)
        CONSTRAINT m_mndsal_nn NOT NULL,
    comm     NUMERIC(6, 2),
...
(
    ...
    hoofd   NUMERIC(4)
        CONSTRAINT a_hoofd_fk REFERENCES medewerkers DEFERRABLE
);
...
(
    ...
    ondergrens NUMERIC(6, 2)
        CONSTRAINT s_onder_nn NOT NULL
        CONSTRAINT s_onder_chk CHECK (ondergrens >= 0),
    bovengrens NUMERIC(6, 2)
        CONSTRAINT s_boven_nn NOT NULL,
    toelage    NUMERIC(6, 2)
        CONSTRAINT s_toelg_nn NOT NULL,
...
(
    ...
    omschrijving VARCHAR(50)
        CONSTRAINT c_omschr_nn NOT NULL,
    type         CHAR(3)
        CONSTRAINT c_type_nn NOT NULL,
    lengte       NUMERIC(2)
        CONSTRAINT c_lengte_nn NOT NULL,
...
(
    ...
    begindatum DATE
        CONSTRAINT u_begin_nn NOT NULL,
    docent     NUMERIC(4)
        CONSTRAINT u_docent_fk REFERENCES medewerkers DEFERRABLE,
    locatie    VARCHAR(20),
...
(
    ...
    cursus     VARCHAR(4)
        CONSTRAINT i_cursus_nn NOT NULL,
    begindatum DATE
        CONSTRAINT i_begin_nn NOT NULL,
    evaluatie  NUMERIC(1)
        CONSTRAINT i_eval_chk CHECK (evaluatie IN (1, 2, 3, 4, 5)),
...
(
    mnr         NUMERIC(4)
        CONSTRAINT h_mnr_nn NOT NULL
        CONSTRAINT h_mnr_fk REFERENCES medewerkers ON DELETE CASCADE DEFERRABLE,
    beginjaar   NUMERIC(4)
        CONSTRAINT h_bjaar_nn NOT NULL,
    begindatum  DATE
        CONSTRAINT h_begin_nn NOT NULL,
    einddatum   DATE,
    afd         NUMERIC(2)
        CONSTRAINT h_afd_nn NOT NULL
