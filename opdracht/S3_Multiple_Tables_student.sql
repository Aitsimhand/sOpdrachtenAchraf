...
SELECT   inschrijvingen.cursist AS cursistNmr,  m.naam AS docentNaam   FROM inschrijvingen, uitvoeringen
...
SELECT afd.naam, m.naam FROM afdelingen AS afd
...
SELECT mw.naam, mw.comm FROM medewerkers AS mw;
