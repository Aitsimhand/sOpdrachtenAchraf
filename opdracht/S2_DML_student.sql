...
SELECT functie, gbdatum FROM medewerkers GROUP BY functie, gbdatum ORDER BY functie, gbdatum;
...
SELECT cursussen.code, inschrijvingen.begindatum FROM cursussen, inschrijvingen, uitvoeringen WHERE (uitvoeringen.locatie = 'UTRECHT' OR uitvoeringen.locatie = 'MAASTRICHT');
...
INSERT INTO uitvoeringen (cursus, begindatum, docent, locatie) VALUES ('S02','2022-3-02', 7369, 'LEERDAM')
...
INSERT INTO medewerkers (mnr, naam, voorl, functie, chef, gbdatum, maandsal, comm, afd, geslacht) VALUES (8001, 'ALBLAS', 'B', 'STAGIAIR', null, '1998-10-24', 1000, null, null, 'M'  )
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
...
INSERT INTO schalen (snr, ondergrens, bovengrens, toelage) VALUES (6, 3001.00, 4000, 500.00)
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
...
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO uitvoeringen (cursus, begindatum, docent, locatie) VALUES ('D&P', '2021-09-27',7369, 'LEERDAM')
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO uitvoeringen (cursus, begindatum, docent, locatie) VALUES ('D&P', '2021-09-30',7369, 'LEERDAM' )
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO inschrijvingen (cursist, cursus, begindatum, evaluatie) VALUES (7499, 'D&P', '2021-09-27', null )
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO inschrijvingen (cursist, cursus, begindatum, evaluatie) VALUES (7566, 'D&P', '2021-09-27', null)
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
INSERT INTO inschrijvingen (cursist, cursus, begindatum, evaluatie) VALUES (7698, 'D&P', '2021-09-30', null)
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]
...
UPDATE medewerkers SET maandsal = maandsal * 1.055 WHERE (afd=30 AND NOT functie='MANAGER');
...
-- Als wij alders zouden willen verwijderen dan moeten we er eerst voot zorgen dat die niet meer is ingeschreven voor een cursus.#TODO!!
...
INSERT INTO medewerkers (mnr, naam, voorl, functie, chef, gbdatum, maandsal, comm, afd, geslacht) VALUES (8003, 'ACHRAF', 'A', 'MANAGER', 7839, '1997-10-24', 2500.00, null, 70, 'M')
ON CONFLICT DO NOTHING;                                                                                         -- [TEST]

UPDATE afdelingen SET hoofd=8003 WHERE naam='FINANCIEN';
-- [TEST]
